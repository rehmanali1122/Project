...
public class FacilityForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Facility Head");

        jButton1.setText("Save Facility");
        ...
        jButton2.setText("Update Facility");

        jButton3.setText("Delete Facility");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        fac.setFacName(jTextField1.getText());
        fac.setFacHead(Integer.parseInt(jTextField2.getText()));
        String facData = createFacility(fac);
        
        JOptionPane.showMessageDialog(null, facData, "Data Inserted..!!", JOptionPane.PLAIN_MESSAGE);
    ...
    public String createFacility(Facility fac)
    {
        ...
        try
        {
            ...
            String q = "insert into Facility (facilityName, facilityHead)" + "values (?, ?)";
            
            PreparedStatement prepareState = con.prepareStatement(q);
            
            prepareState.setString(1, fac.getFacName());
            prepareState.setInt(2, fac.getFacHead());
            
            prepareState.execute();
            con.close();
            
            return "Successfully Facility Inserted..!!";
        }
         ...
         catch(Exception ex)
        {
            ...
            return "Facility Not Registered..!!";
        }
